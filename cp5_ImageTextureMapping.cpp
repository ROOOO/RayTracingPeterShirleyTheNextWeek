...
hitable* two_spheres() {
  ...
  list[0] = new sphere(vec3(0.0f, -1000.0f, 0.0f), 1000.0f, new metal(vec3(0.7f, 0.6f, 0.5f), 0.1f));
  int nx, ny, nn;
  unsigned char* tex_data = stbi_load("earthmap.jpg", &nx, &ny, &nn, 0);
  material* mat = new lambertion(new image_texture(tex_data, nx, ny));
  list[1] = new sphere(vec3(0.0f, 2.0f, 0.0f), 2.0f, mat);
