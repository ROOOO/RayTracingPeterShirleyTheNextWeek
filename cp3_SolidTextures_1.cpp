...
hitable* random_scene() {
  ...
  list[0] = new sphere(vec3(0.0f, -1000.0f, 0.0f), 1000.0f, new lambertion(checker));
  int i = 1;
  for (int a = -11; a < 11; ++a) {
    for (int b = -11; b < 11; ++b) {
      ...
      if ((center - vec3(4.0f, 0.2f, 0.0f)).length() > 0.9f) {
        if (choose_mat < 0.8f) {
          list[i++] = new moving_sphere(center, center + vec3(0.0f, 0.5f * drand48(), 0.0f), 0.0f, 1.0f, 0.2f, new lambertion(vec3(drand48() * drand48(), drand48() * drand48(), drand48() * drand48())));
